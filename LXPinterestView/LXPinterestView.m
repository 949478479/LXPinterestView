...
@implementation LXPinterestView
@dynamic delegate;
...
- (id)dequeueReusableCellWithReuseIdentifier:(NSString *)identifier
{
    ...
    // 根据标识符从重用池获取 cell.
    LXPinterestViewCell *reusableCell;
    for (LXPinterestViewCell *cell in self.reusableCells) {
...
- (LXPinterestViewCell *)cellAtIndex:(NSInteger)index
{
    ...
    for (LXPinterestViewCell *cell in self.visibleCells.allValues) {
...
{
    LXPinterestViewCell *cell = [self.dataSource waterfallFlowView:self cellAtIndex:idx];
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    LXPinterestViewCell *resultCell;
    for (LXPinterestViewCell *cell in self.visibleCells.allValues) {
